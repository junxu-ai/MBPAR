...
% This option to generate a temporary report for debug purpose in Windows only, 
% which is not necessary for final one;
% It requires MS PowerPoint installed. 
options.export_report=0; % 1 generate the temporary file ; 0 don't generate
